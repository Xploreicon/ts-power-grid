...
export async function updateSession(request: NextRequest) {
  ...
  // If Supabase env vars are missing (e.g. preview deploy without secrets),
  // skip auth entirely rather than 500 the whole app. Auth-gated routes will
  // still be unusable, but the marketing site and sign-in page stay online.
